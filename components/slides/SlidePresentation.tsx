...
export default function SlidePresentation({setIsSlidesOpen}:{setIsSlidesOpen: Dispatch<SetStateAction<boolean>>}) {
  ...
  return (
    <div className="fixed inset-0 z-50  w-full h-screen overflow-hidden bg-[#050510] bg-opacity-30 flex flex-col">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20"></div>
